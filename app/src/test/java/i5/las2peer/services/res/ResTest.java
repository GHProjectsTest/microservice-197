...
public class ResTest {
  ...
  public void testFirstTestCase2() {
    ...
    try {
      ...
      assertThat(response, both(isA(JSONArray.class)).and(asJSONObjectList(hasItem(both(isA(JSONObject.class)).and(asJSONObject(hasField("user", isA(JSONObject.class))))))));
